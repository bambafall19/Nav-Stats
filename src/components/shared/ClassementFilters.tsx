            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  padding: '10px 14px',
                  border: 'none',
                  background: !selectedQuartier ? 'rgba(42,255,160,0.1)' : 'transparent',
                  cursor: 'pointer',
                  textAlign: 'left',
                  fontSize: '0.875rem',
              ...
              {quartiers.map(q => (
                <button
                  ...
                  style={{
                    ...
                    padding: '10px 14px',
                    border: 'none',
                    background: selectedQuartier === q ? 'rgba(42,255,160,0.1)' : 'transparent',
                    cursor: 'pointer',
                    textAlign: 'left',
                    fontSize: '0.875rem',
                    borderBottom: '1px solid var(--color-border)',
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  padding: '10px 14px',
                  border: 'none',
                  background: !selectedAsc ? 'rgba(42,255,160,0.1)' : 'transparent',
                  cursor: 'pointer',
                  textAlign: 'left',
                  fontSize: '0.875rem',
                  borderBottom: '1px solid var(--color-border)',
              ...
              {ascs.map(a => (
                <button
                  ...
                  style={{
                    ...
                    padding: '10px 14px',
                    border: 'none',
                    background: selectedAsc === a ? 'rgba(42,255,160,0.1)' : 'transparent',
                    cursor: 'pointer',
                    textAlign: 'left',
                    fontSize: '0.875rem',
                    borderBottom: '1px solid var(--color-border)',
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: '10px 14px',
                    border: 'none',
                    background: selectedPeriod === p.value ? 'rgba(42,255,160,0.1)' : 'transparent',
                    cursor: 'pointer',
                    textAlign: 'left',
                    fontSize: '0.875rem',
